...
function getDuration(dateFrom, dateTo) {
  ...
  if (timeDiff >= TIME_PERIODS.MIN_IN_HOUR * TIME_PERIODS.HOUR_IN_DAY * TIME_PERIODS.DAY_IN_YEAR) {
    return dayjs.duration(timeDiff, 'minutes').format('YY[Y] DD[D] HH[H] mm[M]');
  } else if (timeDiff >= TIME_PERIODS.MIN_IN_HOUR * TIME_PERIODS.HOUR_IN_DAY) {
...
export { getRandomArrayElement, getRandomInteger, humanizeDueDate, getDuration, getLastWord, upperFirstChar};
